...
<head>
	...
	<title>Read Tag : FSR CP Connect</title>
</head>
...
<body>
	...
	<ul class="topnav">
		...
		<li><a class="active" href="read tag.php">Read Tag UID</a></li>
		<li><a href="student attendance.php">Attendance</a></li>
	</ul>

	<br>

	<h3 align="center" id="blink">Please Tag to Display UID or Student Data</h3>
	...
	<div id="show_user_data">
		<form>
			<table width="452" border="1" bordercolor="#2475C6" align="center" cellpadding="0" cellspacing="1" bgcolor="#000" style="padding: 2px">
				<tr>
					<td height="40" align="center" bgcolor="#2475C6">
						<font color="#FFFFFF">
							<b>Student Data</b>
						</font>
					</td>
	...
	<script>
		...
		function showUser(str) {
			if (str == "") {
				...
				xmlhttp.open("GET", "read tag user data.php?uid=" + str, true);
				xmlhttp.send();
			}
		}
